                ...
                <div className="card-container2">
                    <div className="card-intructions">
                        <div className="instr-text">
                            ...
                            <p>Start by placing the detergent cup under your preferred dispenser (white or color) on the HOME page. If it's your first time, enter the detergent you've filled the dispenser with. Otherwise, your pre-selected detergent will be automatically chosen.</p>
                        </div>
                    </div>
                </div>
                <div className="card-container2">
